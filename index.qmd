...
::: callout-note
Plugins only needed to be installed once and they will be available everytine you open QGIS.
:::
...
::: callout-note
**QuickMapSerrvices** has an additional step to enable all the background maps.
...
![](/assets/t-digitise-peatlands-digitise-panel-01.png){fig-align="center"}
